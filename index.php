...
<body>
  <div class="w-form">
    <form id="email-form" action="poker.php" name="email-form" data-name="Email Form" method="post" class="form-2" data-wf-page-id="65a6358f98ae25d9e60af7b3" data-wf-element-id="86774d01-babd-216e-a0af-c3f43d9ae051">
  ...
  <section>
    ...
    <div class="w-layout-grid grid">
          <img src="images/spade/1.png" loading="lazy" id="w-node-_6fc442a9-78b5-a3cb-44b1-bb835f58e573-e60af7b3" alt="">
          <img src="images/spade/2.png" loading="lazy" id="w-node-_333a605a-b6f2-c565-5f59-b5a00f7a8d35-e60af7b3" alt="">
          <img src="images/spade/3.png" loading="lazy" id="w-node-_16c44e8b-02c7-97b3-a263-577708b4887d-e60af7b3" alt="">
          <img src="images/spade/4.png" loading="lazy" id="w-node-a22088a3-377c-c5cc-8d6a-02f806f83211-e60af7b3" alt="">
          <img src="images/spade/5.png" loading="lazy" id="w-node-_71d98ea8-e20b-a252-3a7f-8be194f0a284-e60af7b3" alt="">
    </div>
  </section>
  <h1 class="heading-3"><strong>A poker hand→</strong>Straight Flush</h1>
</body>
</html>
